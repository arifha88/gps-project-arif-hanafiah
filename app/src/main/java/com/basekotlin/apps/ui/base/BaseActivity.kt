...
import com.basekotlin.apps.MovieApplication
import com.basekotlin.apps.injection.component.ActivityComponent
import com.basekotlin.apps.injection.component.ConfigPersistentComponent
import com.basekotlin.apps.injection.component.DaggerConfigPersistentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (configPersistentComponent == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .appComponent(MovieApplication.get(this).getComponent())
                    .build()
