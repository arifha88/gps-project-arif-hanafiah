...
class RetrofitException internal constructor(message: String,
    ...
    companion object {
        ...
        fun networkError(exception: IOException): RetrofitException {
            return RetrofitException(exception.message.toString(), null, null, Kind.NETWORK, exception, null)
        }

        fun unexpectedError(exception: Throwable): RetrofitException {
            return RetrofitException(exception.message.toString(), null, null, Kind.UNEXPECTED, exception, null)
        }
    }
}
